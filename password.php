...
// This page let's a user change their password.
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($errors)) { //If everything is ok
      ...
      if (mysqli_affected_rows($dbc) == 1) { //If it ran ok
          ...
          <p>Your has been updated. In Chapter 12 you will actually
...
<form action="password.php" method="post">
  ...
  <p>Current Password: <input type="text" name="pass" size="10" maxlength="20"
    value="<?php if (isset($_POST['pass'])) echo $_POST['pass']; ?>" /></p>

  <p>New Password: <input type="text" name="pass1" size="10" maxlength="20"
    value="<?php if (isset($_POST['pass1'])) echo $_POST['pass1']; ?>" /></p>

  <p>New Password: <input type="text" name="pass2" size="10" maxlength="20"
